  ...
  <div class="space-y-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div v-for="(price, plan) in plans" :key="plan" class="relative group">
        ...
        <div class="relative bg-white border border-[#E5E5E5] p-10 h-full flex flex-col">
    ...
    <div v-if="paymentInfo" class="fixed inset-0 bg-[#FDFCFB]/90 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
      <div class="bg-white border border-[#E5E5E5] w-full max-w-lg p-12 shadow-[20px_20px_0px_0px_rgba(0,0,0,0.05)]">
        ...
        <div class="flex flex-col items-center">
          <div class="relative mb-8 p-4 border border-[#F5F5F5]">
            ...
            <div class="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#E5E5E5]"></div>
            <div class="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#E5E5E5]"></div>
            <div class="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#E5E5E5]"></div>
            <div class="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#E5E5E5]"></div>
          </div>

          <a
            :href="paymentInfo.confirmation_url"
            target="_blank"
            class="w-full py-4 text-center border border-[#E5E5E5] font-bold uppercase text-xs tracking-widest hover:bg-[#FBF0D3] transition-colors"
          >
